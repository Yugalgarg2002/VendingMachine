...
public class App {
    ...
    private static void displayInventory(VendingMachine vendingMachine) {
        ...
        for (ItemShelf itemShelf : itemShelfSlots) {
            System.out.println("Item Code: " + itemShelf.getItemCode() + " Item: " +
                    itemShelf.getItem().getItemType()
                    + " Item Price: " + itemShelf.getItem().getPrice() + " isAvailable: " +
                    (!itemShelf.isSoldOut()));
